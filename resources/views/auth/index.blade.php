        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    <!--begin::Image-->
                    <img class="theme-light-show mx-auto mw-100 w-350px w-lg-700px mb-10 mb-lg-20"
                        src="assets/media/auth/logo-2.png" alt="" />
                    <img class="theme-dark-show mx-auto mw-100 w-350px w-lg-700px mb-10 mb-lg-20"
                        src="assets/media/auth/logo-2.png" alt="" />
                </div>
                <!--end::Content-->
            </div>
